...
#### Start Idling or Running Other Games or Applications that are not supported in Steam or other applications to showcase your status in Steam using Shell Script.
